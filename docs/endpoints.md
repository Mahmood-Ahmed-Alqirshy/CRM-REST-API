...
| location_id        |  | <ul><li>Number</li><li>Exists in locations table</li></ul>                       |
| birth_date         |  | <ul><li>Date</li><li>Format : Y-m-d</li></ul>                                    |
...
| is_annual       |          | `false` | <ul><li>Boolean</li></ul>                                  |
